...
# BRAPH 2 Hello, World!
The **BRAPH 2 Hello, World!** is a simple BRAPH 2 distribution that showcases the BRAPH 2 Genesis System to create a **standalone**, **unit-tested**, and **GUI-ready** software distribution. 
