classdef ConcreteElement < Element
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'ConcreteElement'  'StringCombine'  'StringUnit'  'BrainAtlas'  'BrainAtlasPF'  'BrainRegion'  'BrainSurface'  'BrainSurfacePF'  'ImporterBrainAtlasXLS'  'ImporterBrainSurfaceNV'  'IndexedDictionary'  'Graph'  'GraphAdjPF'  'GraphHistPF'  'GraphPP_MDict'  'LayersPP'  'Measure'  'MeasurePF'  'MeasurePF_BB'  'MeasurePF_BS'  'MeasurePF_BU'  'MeasurePF_BxPP_Nodes'  'MeasurePF_GB'  'MeasurePF_GS'  'MeasurePF_GU'  'MeasurePF_NB'  'MeasurePF_NS'  'MeasurePF_NU'  'MeasurePF_NxPP_Node'  'MeasurePF_xUPP_Layer'  'ExporterPipelineBRAPH2'  'GUI'  'GUIElement'  'GUIFig'  'GUILayout'  'ImporterPipelineBRAPH2'  'Panel'  'PanelElement'  'PanelFig'  'PanelProp'  'PanelPropAlpha'  'PanelPropClass'  'PanelPropColor'  'PanelPropIDict'  'PanelPropIDictTable'  'PanelPropItem'  'PanelPropItemList'  'PanelPropLine'  'PanelPropLogical'  'PanelPropMarker'  'PanelPropMatrix'  'PanelPropNet'  'PanelPropOption'  'PanelPropRVectorView'  'PanelPropScalar'  'PanelPropSize'  'PanelPropString'  'PanelPropStringTextArea'  'Pipeline'  'PipelineCode'  'PipelinePP_Notes'  'PipelinePP_PSDict'  'PipelineSection'  'Settings'  'SettingsAmbient'  'SettingsAmbientPP'  'SettingsArea'  'SettingsAreaPP'  'SettingsAxis'  'SettingsAxisPP'  'SettingsLine'  'SettingsLinePP'  'SettingsPP'  'SettingsPosition'  'SettingsPositionPP'  'SettingsSphere'  'SettingsSurface'  'SettingsSurfacePP'  'SettingsSymbol'  'SettingsText'  'SettingsTextPP'  'GTA_AL'  'GTA_CA'  'GTA_CO'  'GTA_DI'  'GTA_EM'  'GTA_IT'  'GTA_LL'  'GTA_LN'  'GTA_LO'  'GTA_MR'  'GTA_NC'  'GTA_NM'  'GTA_NN'  'GTA_NR'  'GTA_NS'  'GTA_OP'  'GTA_PanelProp'  'GTA_ST'  'GTA_ST_TA'  'GTA_SZ'  'Exporter'  'Importer' }; %CET: Computational Efficiency Trick
		end
