classdef ConcreteElement < Element
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'ConcreteElement'  'StringCombine'  'StringUnit'  'IndexedDictionary'  'ExporterPipelineBRAPH2'  'GUI'  'GUIElement'  'GUIFig'  'GUILayout'  'ImporterPipelineBRAPH2'  'Panel'  'PanelElement'  'PanelFig'  'PanelProp'  'PanelPropItem'  'PanelPropString'  'PanelPropStringTextArea'  'Pipeline'  'PipelineCode'  'PipelinePP_Notes'  'PipelinePP_PSDict'  'PipelineSection'  'GTA_AL'  'GTA_CA'  'GTA_CO'  'GTA_DI'  'GTA_EM'  'GTA_IT'  'GTA_LL'  'GTA_LN'  'GTA_LO'  'GTA_MR'  'GTA_NC'  'GTA_NM'  'GTA_NN'  'GTA_NR'  'GTA_NS'  'GTA_OP'  'GTA_PanelProp'  'GTA_ST'  'GTA_ST_TA'  'GTA_SZ'  'Exporter'  'Importer' }; %CET: Computational Efficiency Trick
		end
