	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case MeasurePF_NS.NODE % __MeasurePF_NS.NODE__
					prop_default = 1;
				case MeasurePF_NS.ELCLASS % __MeasurePF_NS.ELCLASS__
					prop_default = 'MeasurePF_NS';
				case MeasurePF_NS.NAME % __MeasurePF_NS.NAME__
					prop_default = 'Panel Figure for Nodal Superglobal Measure';
				case MeasurePF_NS.DESCRIPTION % __MeasurePF_NS.DESCRIPTION__
				...
				case MeasurePF_NS.ID % __MeasurePF_NS.ID__
					prop_default = 'MeasurePF_NS ID';
				case MeasurePF_NS.LABEL % __MeasurePF_NS.LABEL__
					prop_default = 'MeasurePF_NS label';
				case MeasurePF_NS.NOTES % __MeasurePF_NS.NOTES__
