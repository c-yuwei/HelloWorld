classdef Graph < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Graph' }; %CET: Computational Efficiency Trick
		end
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case Graph.PFGH % __Graph.PFGH__
					prop_default = Format.getFormatDefault(8, Graph.getPropSettings(prop));
				case Graph.ELCLASS % __Graph.ELCLASS__
					prop_default = 'Graph';
				case Graph.NAME % __Graph.NAME__
					prop_default = 'Graph';
				case Graph.DESCRIPTION % __Graph.DESCRIPTION__
				...
				case Graph.ID % __Graph.ID__
					prop_default = 'Graph ID';
				case Graph.LABEL % __Graph.LABEL__
					prop_default = 'Graph label';
				case Graph.NOTES % __Graph.NOTES__
