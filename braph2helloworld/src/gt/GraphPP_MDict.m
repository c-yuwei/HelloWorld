	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case GraphPP_MDict.GUI_M_DICT % __GraphPP_MDict.GUI_M_DICT__
					prop_default = Format.getFormatDefault(10, GraphPP_MDict.getPropSettings(prop));
				case GraphPP_MDict.ELCLASS % __GraphPP_MDict.ELCLASS__
					prop_default = 'GraphPP_MDict';
				case GraphPP_MDict.NAME % __GraphPP_MDict.NAME__
					prop_default = 'Measure Dictionary Plot';
				case GraphPP_MDict.DESCRIPTION % __GraphPP_MDict.DESCRIPTION__
				...
				case GraphPP_MDict.ID % __GraphPP_MDict.ID__
					prop_default = 'GraphPP_MDict';
				case GraphPP_MDict.LABEL % __GraphPP_MDict.LABEL__
					prop_default = 'GraphPP_MDict label';
				case GraphPP_MDict.NOTES % __GraphPP_MDict.NOTES__
					prop_default = 'GraphPP_MDict';
				case GraphPP_MDict.EL % __GraphPP_MDict.EL__
					prop_default = Graph();
				case GraphPP_MDict.PROP % __GraphPP_MDict.PROP__
