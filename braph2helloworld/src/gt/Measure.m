classdef Measure < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Measure' }; %CET: Computational Efficiency Trick
		end
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case Measure.PFM % __Measure.PFM__
					prop_default = Format.getFormatDefault(8, Measure.getPropSettings(prop));
				case Measure.ELCLASS % __Measure.ELCLASS__
					prop_default = 'Measure';
				case Measure.NAME % __Measure.NAME__
					prop_default = 'Measure';
				case Measure.DESCRIPTION % __Measure.DESCRIPTION__
				...
				case Measure.TEMPLATE % __Measure.TEMPLATE__
					prop_default = Format.getFormatDefault(8, Measure.getPropSettings(prop));
				case Measure.ID % __Measure.ID__
					prop_default = 'Measure ID';
				case Measure.LABEL % __Measure.LABEL__
					prop_default = 'Measure label';
				case Measure.NOTES % __Measure.NOTES__
