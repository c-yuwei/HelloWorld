classdef MeasurePF_BxPP_Nodes < PanelProp
	%MeasurePF_BxPP_Nodes plots the panel to select a couple of nodes of a binodal measure.
	...
	%
	% The list of MeasurePF_BxPP_Nodes properties is:
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the nodes prop panel (MeasurePF_BxPP_Nodes).
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = MeasurePF_BxPP_Nodes.GETBUILD() returns the build of 'MeasurePF_BxPP_Nodes'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the nodes prop panel PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('MeasurePF_BxPP_Nodes') returns the build of 'MeasurePF_BxPP_Nodes'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('MeasurePF_BxPP_Nodes')
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'MeasurePF_BxPP_Nodes' }; %CET: Computational Efficiency Trick
		end
		...
		function check_out = existsProp(prop)
			...
			elseif ~check
				error( ...
					['BRAPH2' ':MeasurePF_BxPP_Nodes:' 'WrongInput'], ...
					['BRAPH2' ':MeasurePF_BxPP_Nodes:' 'WrongInput' '\n' ...
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_bxpp_nodes_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  7  7 };
			prop_category = measurepf_bxpp_nodes_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_bxpp_nodes_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  18  18 };
			prop_format = measurepf_bxpp_nodes_format_list{prop};
		end
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case MeasurePF_BxPP_Nodes.DROPDOWN_NODE1 % __MeasurePF_BxPP_Nodes.DROPDOWN_NODE1__
					prop_default = Format.getFormatDefault(18, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case MeasurePF_BxPP_Nodes.DROPDOWN_NODE2 % __MeasurePF_BxPP_Nodes.DROPDOWN_NODE2__
					prop_default = Format.getFormatDefault(18, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case MeasurePF_BxPP_Nodes.ELCLASS % __MeasurePF_BxPP_Nodes.ELCLASS__
					prop_default = 'MeasurePF_BxPP_Nodes';
				case MeasurePF_BxPP_Nodes.NAME % __MeasurePF_BxPP_Nodes.NAME__
					prop_default = 'Nodes Prop Panel';
				case MeasurePF_BxPP_Nodes.DESCRIPTION % __MeasurePF_BxPP_Nodes.DESCRIPTION__
				...
				case MeasurePF_BxPP_Nodes.TEMPLATE % __MeasurePF_BxPP_Nodes.TEMPLATE__
					prop_default = Format.getFormatDefault(8, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case MeasurePF_BxPP_Nodes.ID % __MeasurePF_BxPP_Nodes.ID__
					prop_default = 'MeasurePF_BxPP_Nodes ID';
				case MeasurePF_BxPP_Nodes.LABEL % __MeasurePF_BxPP_Nodes.LABEL__
					prop_default = 'MeasurePF_BxPP_Nodes label';
				case MeasurePF_BxPP_Nodes.NOTES % __MeasurePF_BxPP_Nodes.NOTES__
					prop_default = 'MeasurePF_BxPP_Nodes notes';
				case MeasurePF_BxPP_Nodes.EL % __MeasurePF_BxPP_Nodes.EL__
					prop_default = MeasurePF_BU();
				case MeasurePF_BxPP_Nodes.PROP % __MeasurePF_BxPP_Nodes.PROP__
					prop_default = MeasurePF_BU.NODES;
				case MeasurePF_BxPP_Nodes.HEIGHT % __MeasurePF_BxPP_Nodes.HEIGHT__
					prop_default = 48;
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case MeasurePF_BxPP_Nodes.DROPDOWN_NODE1 % __MeasurePF_BxPP_Nodes.DROPDOWN_NODE1__
					check = Format.checkFormat(18, value, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case MeasurePF_BxPP_Nodes.DROPDOWN_NODE2 % __MeasurePF_BxPP_Nodes.DROPDOWN_NODE2__
					check = Format.checkFormat(18, value, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				case MeasurePF_BxPP_Nodes.TEMPLATE % __MeasurePF_BxPP_Nodes.TEMPLATE__
					check = Format.checkFormat(8, value, MeasurePF_BxPP_Nodes.getPropSettings(prop));
				otherwise
