	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case MeasurePF_BB.ELCLASS % __MeasurePF_BB.ELCLASS__
					prop_default = 'MeasurePF_BB';
				case MeasurePF_BB.NAME % __MeasurePF_BB.NAME__
					prop_default = 'Panel Figure for Binodal Bilayer Measure';
				case MeasurePF_BB.DESCRIPTION % __MeasurePF_BB.DESCRIPTION__
				...
				case MeasurePF_BB.ID % __MeasurePF_BB.ID__
					prop_default = 'MeasurePF_BB ID';
				case MeasurePF_BB.LABEL % __MeasurePF_BB.LABEL__
					prop_default = 'MeasurePF_BB label';
				case MeasurePF_BB.NOTES % __MeasurePF_BB.NOTES__
