classdef MeasurePF_NU < MeasurePF
	%MeasurePF_NU is the base element to plot the panel figure of the nodal unilayer measure.
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the panel figure for nodal unilayer measure (MeasurePF_NU).
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the panel figure for nodal unilayer measure.
			%
			% BUILD = MeasurePF_NU.GETBUILD() returns the build of 'MeasurePF_NU'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PF.GETBUILD() returns the build of the panel figure for nodal unilayer measure PF.
			%  BUILD = Element.GETBUILD(PF) returns the build of 'PF'.
			%  BUILD = Element.GETBUILD('MeasurePF_NU') returns the build of 'MeasurePF_NU'.
			%
			% Note that the Element.GETBUILD(PF) and Element.GETBUILD('MeasurePF_NU')
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case MeasurePF_NU.LAYER % __MeasurePF_NU.LAYER__
					prop_settings = Format.getFormatSettings(11);
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case MeasurePF_NU.LAYER % __MeasurePF_NU.LAYER__
					prop_default = 1;
				case MeasurePF_NU.ELCLASS % __MeasurePF_NU.ELCLASS__
					prop_default = 'MeasurePF_NU';
				case MeasurePF_NU.NAME % __MeasurePF_NU.NAME__
					prop_default = 'Panel Figure for Nodal Unilayer Measure';
				case MeasurePF_NU.DESCRIPTION % __MeasurePF_NU.DESCRIPTION__
				...
				case MeasurePF_NU.ID % __MeasurePF_NU.ID__
					prop_default = 'MeasurePF_NU ID';
				case MeasurePF_NU.LABEL % __MeasurePF_NU.LABEL__
					prop_default = 'MeasurePF_NU label';
				case MeasurePF_NU.NOTES % __MeasurePF_NU.NOTES__
