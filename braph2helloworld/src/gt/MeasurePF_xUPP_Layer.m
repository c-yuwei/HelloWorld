	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case MeasurePF_xUPP_Layer.ELCLASS % __MeasurePF_xUPP_Layer.ELCLASS__
					prop_default = 'MeasurePF_xUPP_Layer';
				case MeasurePF_xUPP_Layer.NAME % __MeasurePF_xUPP_Layer.NAME__
					prop_default = 'Layer Prop Panel';
				case MeasurePF_xUPP_Layer.DESCRIPTION % __MeasurePF_xUPP_Layer.DESCRIPTION__
				...
				case MeasurePF_xUPP_Layer.ID % __MeasurePF_xUPP_Layer.ID__
					prop_default = 'MeasurePF_xUPP_Layer ID';
				case MeasurePF_xUPP_Layer.LABEL % __MeasurePF_xUPP_Layer.LABEL__
					prop_default = 'MeasurePF_xUPP_Layer label';
				case MeasurePF_xUPP_Layer.NOTES % __MeasurePF_xUPP_Layer.NOTES__
					prop_default = 'MeasurePF_xUPP_Layer notes';
				case MeasurePF_xUPP_Layer.EL % __MeasurePF_xUPP_Layer.EL__
					prop_default = MeasurePF_NU();
				case MeasurePF_xUPP_Layer.PROP % __MeasurePF_xUPP_Layer.PROP__
					prop_default = MeasurePF_NU.LAYER;
				case MeasurePF_xUPP_Layer.HEIGHT % __MeasurePF_xUPP_Layer.HEIGHT__
					prop_default = 48;
				otherwise
