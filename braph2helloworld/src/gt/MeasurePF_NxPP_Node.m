classdef MeasurePF_NxPP_Node < PanelProp
	...
	methods (Static) % inspection
		function build = getBuild()
			...
			%
			% BUILD = MeasurePF_NxPP_Node.GETBUILD() returns the build of 'MeasurePF_NxPP_Node'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the node prop panel PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('MeasurePF_NxPP_Node') returns the build of 'MeasurePF_NxPP_Node'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('MeasurePF_NxPP_Node')
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case MeasurePF_NxPP_Node.ELCLASS % __MeasurePF_NxPP_Node.ELCLASS__
					prop_default = 'MeasurePF_NxPP_Node';
				case MeasurePF_NxPP_Node.NAME % __MeasurePF_NxPP_Node.NAME__
					prop_default = 'Node Prop Panel';
				case MeasurePF_NxPP_Node.DESCRIPTION % __MeasurePF_NxPP_Node.DESCRIPTION__
				...
				case MeasurePF_NxPP_Node.ID % __MeasurePF_NxPP_Node.ID__
					prop_default = 'MeasurePF_NxPP_Node ID';
				case MeasurePF_NxPP_Node.LABEL % __MeasurePF_NxPP_Node.LABEL__
					prop_default = 'MeasurePF_NxPP_Node label';
				case MeasurePF_NxPP_Node.NOTES % __MeasurePF_NxPP_Node.NOTES__
					prop_default = 'MeasurePF_NxPP_Node notes';
				case MeasurePF_NxPP_Node.EL % __MeasurePF_NxPP_Node.EL__
					prop_default = MeasurePF_NU();
				case MeasurePF_NxPP_Node.PROP % __MeasurePF_NxPP_Node.PROP__
					prop_default = MeasurePF_NU.NODE;
				case MeasurePF_NxPP_Node.HEIGHT % __MeasurePF_NxPP_Node.HEIGHT__
					prop_default = 48;
				otherwise
