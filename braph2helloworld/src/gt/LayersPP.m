	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case LayersPP.ELCLASS % __LayersPP.ELCLASS__
					prop_default = 'LayersPP';
				case LayersPP.NAME % __LayersPP.NAME__
					prop_default = 'Layers Prop Panel';
				case LayersPP.DESCRIPTION % __LayersPP.DESCRIPTION__
				...
				case LayersPP.ID % __LayersPP.ID__
					prop_default = 'LayersPP ID';
				case LayersPP.LABEL % __LayersPP.LABEL__
					prop_default = 'LayersPP label';
				case LayersPP.NOTES % __LayersPP.NOTES__
					prop_default = 'LayersPP notes';
				case LayersPP.EL % __LayersPP.EL__
					prop_default = GraphHistPF();
				case LayersPP.PROP % __LayersPP.PROP__
