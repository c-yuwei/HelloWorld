classdef MeasurePF_BS < MeasurePF
	%MeasurePF_BS is the base element to plot the panel figure of a binodal superglobal measure.
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the panel figure for binodal superglobal measure (MeasurePF_BS).
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the panel figure for binodal superglobal measure.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the panel figure for binodal superglobal measure.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the panel figure for binodal superglobal measure.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the panel figure for binodal superglobal measure.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the panel figure for binodal superglobal measure.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the panel figure for binodal superglobal measure.
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_bs_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  7  2  6  7  8  7  7  8  7  7  8  7  8  7  8  8 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measurepf_bs_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  8  18  8  1  18  8  18  18  8  18  18  8  18  8  18  8  12 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case MeasurePF_BS.NODES % __MeasurePF_BS.NODES__
					prop_default = [1 1];
				case MeasurePF_BS.ELCLASS % __MeasurePF_BS.ELCLASS__
					prop_default = 'MeasurePF_BS';
				case MeasurePF_BS.NAME % __MeasurePF_BS.NAME__
					prop_default = 'Panel Figure for Binodal Superglobal Measure';
				case MeasurePF_BS.DESCRIPTION % __MeasurePF_BS.DESCRIPTION__
				...
				case MeasurePF_BS.ID % __MeasurePF_BS.ID__
					prop_default = 'MeasurePF_BS ID';
				case MeasurePF_BS.LABEL % __MeasurePF_BS.LABEL__
					prop_default = 'MeasurePF_BS label';
				case MeasurePF_BS.NOTES % __MeasurePF_BS.NOTES__
