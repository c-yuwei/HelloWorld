	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case BrainAtlas.ELCLASS % __BrainAtlas.ELCLASS__
					prop_default = 'BrainAtlas';
				case BrainAtlas.NAME % __BrainAtlas.NAME__
					prop_default = 'Brain Atlas';
				case BrainAtlas.DESCRIPTION % __BrainAtlas.DESCRIPTION__
				...
				case BrainAtlas.TEMPLATE % __BrainAtlas.TEMPLATE__
					prop_default = Format.getFormatDefault(8, BrainAtlas.getPropSettings(prop));
				case BrainAtlas.ID % __BrainAtlas.ID__
					prop_default = 'BrainAtlas ID';
				case BrainAtlas.LABEL % __BrainAtlas.LABEL__
					prop_default = 'BrainAtlas label';
				case BrainAtlas.NOTES % __BrainAtlas.NOTES__
