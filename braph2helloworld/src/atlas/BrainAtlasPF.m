classdef BrainAtlasPF < BrainSurfacePF
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'BrainAtlasPF' }; %CET: Computational Efficiency Trick
		end
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case BrainAtlasPF.LAB_DICT % __BrainAtlasPF.LAB_DICT__
					prop_default = Format.getFormatDefault(10, BrainAtlasPF.getPropSettings(prop));
				case BrainAtlasPF.ELCLASS % __BrainAtlasPF.ELCLASS__
					prop_default = 'BrainAtlasPF';
				case BrainAtlasPF.NAME % __BrainAtlasPF.NAME__
					prop_default = 'Panel Figure for Brain Atlas';
				case BrainAtlasPF.DESCRIPTION % __BrainAtlasPF.DESCRIPTION__
				...
				case BrainAtlasPF.TEMPLATE % __BrainAtlasPF.TEMPLATE__
					prop_default = Format.getFormatDefault(8, BrainAtlasPF.getPropSettings(prop));
				case BrainAtlasPF.ID % __BrainAtlasPF.ID__
					prop_default = 'BrainAtlasPF ID';
				case BrainAtlasPF.LABEL % __BrainAtlasPF.LABEL__
					prop_default = 'BrainAtlasPF label';
				case BrainAtlasPF.NOTES % __BrainAtlasPF.NOTES__
