	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case BrainSurface.TRIANGLES % __BrainSurface.TRIANGLES__
					prop_default = Format.getFormatDefault(14, BrainSurface.getPropSettings(prop));
				case BrainSurface.ELCLASS % __BrainSurface.ELCLASS__
					prop_default = 'BrainSurface';
				case BrainSurface.NAME % __BrainSurface.NAME__
					prop_default = 'Brain Surface';
				case BrainSurface.DESCRIPTION % __BrainSurface.DESCRIPTION__
				...
				case BrainSurface.ID % __BrainSurface.ID__
					prop_default = 'BrainSurface ID';
				case BrainSurface.LABEL % __BrainSurface.LABEL__
					prop_default = 'BrainSurface label';
				case BrainSurface.NOTES % __BrainSurface.NOTES__
