	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case ImporterBrainAtlasXLS.ELCLASS % __ImporterBrainAtlasXLS.ELCLASS__
					prop_default = 'ImporterBrainAtlasXLS';
				case ImporterBrainAtlasXLS.NAME % __ImporterBrainAtlasXLS.NAME__
					prop_default = 'Brain Atlas Importer from XLS/XLSX Files';
				case ImporterBrainAtlasXLS.DESCRIPTION % __ImporterBrainAtlasXLS.DESCRIPTION__
				...
				case ImporterBrainAtlasXLS.TEMPLATE % __ImporterBrainAtlasXLS.TEMPLATE__
					prop_default = Format.getFormatDefault(8, ImporterBrainAtlasXLS.getPropSettings(prop));
				case ImporterBrainAtlasXLS.ID % __ImporterBrainAtlasXLS.ID__
					prop_default = 'ImporterBrainAtlasXLS ID';
				case ImporterBrainAtlasXLS.LABEL % __ImporterBrainAtlasXLS.LABEL__
					prop_default = 'ImporterBrainAtlasXLS label';
				case ImporterBrainAtlasXLS.NOTES % __ImporterBrainAtlasXLS.NOTES__
