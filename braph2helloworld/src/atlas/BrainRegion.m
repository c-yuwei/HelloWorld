	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case BrainRegion.Z % __BrainRegion.Z__
					prop_default = Format.getFormatDefault(11, BrainRegion.getPropSettings(prop));
				case BrainRegion.ELCLASS % __BrainRegion.ELCLASS__
					prop_default = 'BrainRegion';
				case BrainRegion.NAME % __BrainRegion.NAME__
					prop_default = 'Brain Region';
				case BrainRegion.DESCRIPTION % __BrainRegion.DESCRIPTION__
				...
				case BrainRegion.ID % __BrainRegion.ID__
					prop_default = 'BrainRegion ID';
				case BrainRegion.LABEL % __BrainRegion.LABEL__
					prop_default = 'BrainRegion label';
				case BrainRegion.NOTES % __BrainRegion.NOTES__
