classdef Panel < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Panel'  'PanelElement'  'PanelFig'  'PanelProp'  'PanelPropItem'  'PanelPropString'  'PanelPropStringTextArea'  'PipelinePP_Notes'  'PipelinePP_PSDict' }; %CET: Computational Efficiency Trick
		end
