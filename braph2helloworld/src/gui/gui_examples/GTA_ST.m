classdef GTA_ST < ConcreteElement
	...
	% GTA_ST tests PanelPropString.
	%
	% The list of GTA_ST properties is:
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'GTA_ST' }; %CET: Computational Efficiency Trick
		end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				gta_st_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'ST_C'  'ST_M'  'ST_P'  'ST_D'  'ST_R'  'ST_Q'  'ST_E'  'ST_F'  'ST_G' };
				tag = gta_st_tag_list{pointer}; % prop = pointer
			end
		end
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			gta_st_category_list = { 1  1  1  3  4  2  2  6  1  2  3  4  5  6  7  8  9 };
			prop_category = gta_st_category_list{prop};
		end
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			gta_st_format_list = { 2  2  2  8  2  2  2  2  2  2  2  2  2  2  2  2  2 };
			prop_format = gta_st_format_list{prop};
		end
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case GTA_ST.ST_C % __GTA_ST.ST_C__
					prop_default = Format.getFormatDefault(2, GTA_ST.getPropSettings(prop));
				case GTA_ST.ST_M % __GTA_ST.ST_M__
					prop_default = Format.getFormatDefault(2, GTA_ST.getPropSettings(prop));
				case GTA_ST.ST_P % __GTA_ST.ST_P__
					prop_default = Format.getFormatDefault(2, GTA_ST.getPropSettings(prop));
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case GTA_ST.ST_C % __GTA_ST.ST_C__
					check = Format.checkFormat(2, value, GTA_ST.getPropSettings(prop));
				case GTA_ST.ST_M % __GTA_ST.ST_M__
					check = Format.checkFormat(2, value, GTA_ST.getPropSettings(prop));
				case GTA_ST.ST_P % __GTA_ST.ST_P__
					check = Format.checkFormat(2, value, GTA_ST.getPropSettings(prop));
