classdef PanelPropLogical < PanelProp
	...
	%  <strong>1</strong> <strong>ELCLASS</strong> 	ELCLASS (constant, string) is the class of the logical property panel.
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the logical property panel.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the logical property panel.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the logical property panel.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the logical property panel.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the logical property panel.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the logical property panel.
	...
	methods (Static) % inspection
		function build = getBuild()
			%GETBUILD returns the build of the logical prop panel.
			%
			% BUILD = PanelPropLogical.GETBUILD() returns the build of 'PanelPropLogical'.
			%
			% Alternative forms to call this method are:
			%  BUILD = PR.GETBUILD() returns the build of the logical prop panel PR.
			%  BUILD = Element.GETBUILD(PR) returns the build of 'PR'.
			%  BUILD = Element.GETBUILD('PanelPropLogical') returns the build of 'PanelPropLogical'.
			%
			% Note that the Element.GETBUILD(PR) and Element.GETBUILD('PanelPropLogical')
